        ...
        <div class="container">
            <div class="row">
                <div class="col-md-10 mx-auto">
                    ...
                    <button class="btn btn-danger float-end fw-bolder px-4">Confirmer le Paiement</button>
                    </a>
                    
                    <button class="btn btn-danger float-end fw-bolder px-4">TOTAL A PAYER: {{$d}}FCFA</button>
                </div>
            </div>
        </div>
    </div>
