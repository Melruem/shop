        ...
        <div class="container" style="background-color: white; color: white;">
            <div class="row" style="background-color: white; color: white;">
                <div class="col-md-10 mx-auto" style="background-color: white; color: white;">
                    <table class="table bg-white shadow-md">
                        ...
                        <tr class="align-middle">
                            ...
                            <td>
                                ...
                                <button class="btn btn-xs pt-2 btn-danger" style="background-color: white; color: white;"><i class="bi bi-trash"></i></button>
                                </a>
                            </td>
                        </tr>
                        @php
                    ...
                    <button class="btn btn-danger float-end fw-bolder px-4" style="background-color: white; color: white;">Confirmer le Paiement</button>
                    </a>
                    
                    <button class="btn btn-danger float-end fw-bolder px-4" style="background-color: white; color: white;">TOTAL A PAYER: {{$d}}FCFA</button>
                </div>
            </div>
        </div>
    </div>
