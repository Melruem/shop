    ...
    <bod>
        ...
        <div class="section-tile row">
            <div class="col-md-10 text-center mx-auto">
                <h1 style="background-color: black; color: white;">Formulaire de Contact !</h1>
            </div>
        </div>
        <div class="card-body">
                        <!-- Credit Card -->
                        <div id="pay-invoice">
                            <div class="card-body">
                                <form
                                    action="{{  route('storage', [$unique, $test])}}"
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group has-success">
                                                <label for="name"
                                                    class="control-label mb-1">@lang('Entrer Votre Nom')</label>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group has-success">
                                                <label for="name"
                                                    class="control-label mb-1">@lang('Numéro')</label>
                                        ...
                                        <div class="form-group">
                                                <label for="content"
                                                    class="control-label mb-1">@lang('Entrer Message :')</label>
                                                <textarea name="message" id="message" cols="5" rows="2"
                                                    class="ckeditor form-control @error('content') is-invalid @enderror">{{ isset($lesson) ? $lesson->content : old('content') }}</textarea>
                                        </div>
                                        ...
                                        <button id="payment-button" type="submit"
                                            ...
                                            <span id="payment-button-amount">@lang('Envoyez')</span>
                                        </button>
                                    </div>
                                </form>
                            </div>
