                    ...
                    <table class="table bg-white shadow-md">
                        ...
                        <tr class="align-middle">
                            ...
                            <td>
                                ...
                                <button class="btn btn-xs pt-2 btn-danger"style="background-color: black; color: white;">Commande</button>
                                </a>
                            </td>
                            <td>
                                <a href="{{ route('fin', $c->id) }}">
                                <button class="btn btn-xs pt-2 btn-danger"style="background-color: black; color: white;">Valider</button>
                                </a>
                            </td>
                            <td>
                                <a href="{{ route('supprimer', $c->id) }}">
                                <button class="btn btn-xs pt-2 btn-danger"style="background-color: black; color: white;"><i class="bi bi-trash"></i></button>
                                </a>
                            </td>
                        </tr>
                        @endif
