    ...
    <bod>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 d-flex align-items-end">
                            <ul class="ms-auto d-inline-flex">
                                <li class="p-2"><a target="_blank" href=""><button class="btn px-4 btn-danger"674 83 53 76>Login</button></a></li>
                                <li class="p-2"><a target="_blank" href=""><button class="btn px-4 btn-outline-danger"674 83 53 76>Sign Up</button></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="container"style="background-color: white; color: white;">
                  ...
                  <a class="text-white" data-bs-target="#menu" data-bs-toggle="collapse" aria-expanded="false" aria-controls="menu"><i class="bi cp bi-list float-end fs-1 dmji"></i></a> 
                    ...
                    <ul id="menu" class=" navcol fw-bold d-none d-md-inline-flex">
                        ...
                        @else
                        <li class="p-21 px-4"><a class="text-white" href="{{ route('homee', [$unique, $nul]) }}">Home<i class="bi pt-2 bi-chevron-down"></i></a> 
                        </li>
                        @endif
                        @if(isset($test))
                        ...
                        @else
                        <li class="p-21 px-4"><a class="text-white" href="{{ route('stock', [$unique, $nul]) }}">Nos Produits <i class="bi pt-2 bi-chevron-down"></i></a> 
                        </li>
                        @endif
                        @if(isset($test))
                        ...
                        @else
                        <li class="p-21 px-4"><a class="text-white" href="{{ route('session', [$unique, $nul]) }}">Nos Formations <i class="bi pt-2 bi-chevron-down"></i></a> 
                        </li>
                        @endif
                        @if(isset($test))
                        ...
                        @else
                        <li class="p-21 px-4"><a class="text-white" href="{{ route('about', [$unique, $nul]) }}">A Propos de Nous <i class="bi pt-2 bi-chevron-down"></i></a> 
                        </li>
                        @endif
                    </ul>
                </div>
        ...
        <div class="section-tile row">
            <div class="col-md-10 text-center mx-auto">
                <h1 style="background-color: white; color: white;">Veuillez founir vos informations pour vous connecter s'il vous plait !</h1>
            </div>
        </div>
        <div class="card-body">
                        <!-- Credit Card -->
                        <div id="pay-invoice">
                            <div class="card-body">
                                <form
                                    action="{{  route('loginn', [$unique, $test])}}"
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group has-success">
                                                <label for="name"
                                                    class="control-label mb-1">@lang('Email')</label>
                                        ...
                                        <button id="payment-button" type="submit"
                                            ...
                                            <span id="payment-button-amount">@lang('connexion')</span>
                                        </button>
                                    </div>
                                </form>
                            </div>
