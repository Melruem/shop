...
<!doctype html>
    ...
    <bod>
        ...
        <div class="section-tile row"style="background-color: purple; color: white;">
        ...
        <div class="container"style="background-color: purple; color: white;">
            <div class="row"style="background-color: purple; color: white;">
                <div class="col-md-10 mx-auto"style="background-color: purple; color: white;">
                    ...
                    <button class="btn btn-danger float-end fw-bolder px-4"style="background-color: purple; color: white;">TOTAL A PAYER: {{$produit->prix}}FCFA</button>
                </div>
            </div>
        </div>
    </div>
