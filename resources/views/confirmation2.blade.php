...
<!doctype html>
    ...
    <bod>
        ...
        <div class="section-tile row"style="background-color: black; color: white;">
            <div class="col-md-10 text-center mx-auto"style="background-color: black; color: white;">
                <h1>Veuillez remplir tous les champs s'il vous plait !!!</h1>
                <h3>Ces informations nous aiderons à assurer la fiabilité et la rapidité de nos livraisons.</h3>
                ...
                <div class="col-md-10 mx-auto"style="background-color: black; color: white;">
                    <table class="table bg-white shadow-md">
                        ...
                        <tr class="align-middle">
                            <td>{{$produit->id}}</td>
                            <td>
                                <img src="{{asset($produit->image)}}" width="200px" />
                            </td>
                            <td>{{$produit->nom}}</td>
                            <td>1</td>
                            <td>{{$produit->prix}}</td>
                            <td>{{$produit->prix}}</td>
                            <td>
                                <a href="{{ route('delete', [$produit->id, $unique, $test ]) }}">
                    ...
                    <button class="btn btn-danger float-end fw-bolder px-4"style="background-color: white; color: white;">TOTAL A PAYER: {{$produit->prix}}FCFA</button>
                </div>
            </div>
        </div>
    </div>
                                ...
                                <form
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group has-success">
                                                <label for="name"
                                                    class="control-label mb-1">@lang('Lieu de la livraison')</label>
                                        ...
                                        <div class="col-4">
                                            <div class="form-group">
                                                <label for="valid_from"
                                                    class="control-label mb-1">@lang('Jour de livraison')</label>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group has-success">
                                                <label for="name"
                                                    class="control-label mb-1">@lang('Heure de la livraison')</label>
